...
const char MYNTEYE_SDK_ROOT_DIR[] = "D:\\programe\\s\\mynt-eye-s-sdk";
const char MYNTEYE_SDK_INSTALL_DIR[] = "D:\\programe\\s\\mynt-eye-s-sdk\\_install";
...
#define WITH_OPENCV3
/* #undef WITH_OPENCV4 */
#define WITH_OPENCV_WORLD

/* #undef WITH_GLOG */
#define WITH_FILESYSTEM
/* #undef WITH_BOOST_FILESYSTEM */
#define WITH_NATIVE_FILESYSTEM
